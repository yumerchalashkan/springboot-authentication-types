package com.springboot.basicauthentication.security;
    ...
    public SecurityFilterChain filterChain(HttpSecurity security, HandlerMappingIntrospector introspector) throws Exception{
        ...
        security
                ...
                .authorizeHttpRequests(x->
                                        ...
                                        .requestMatchers(mvcRequestBuilder.pattern("/private/**")).hasAnyRole(Role.ROLE_ADMIN.getValue(), Role.ROLE_USER.getValue(), Role.ROLE_MOD.getValue())
